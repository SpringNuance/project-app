...
/* Part 2 */
// Go to each page of a project, from "findById"
...
const viewSingleProject = async (request) => {
  ...
  const data = {
    ...
    currentIssues: await issueService.findCurrentIssues(urlParts[2]),
  };
...
export { viewAllProjects, addProject, removeProject , viewSingleProject};
